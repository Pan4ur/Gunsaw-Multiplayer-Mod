internal readonly struct WorldBodySnapshot
{
    ...
    internal void Write(ref PacketWriter writer)
    {
        ...
        writer.WriteBoolean(Simulated);
        writer.WriteBoolean(Awake);
        writer.WriteBoolean(SafetyRailing);
        writer.WriteBoolean(SafetyRailingAttached);
        writer.WriteBoolean(IsVehiclePart);
        if (IsVehiclePart)
        {
            writer.WriteSingle(VehiclePartHealth);
            writer.WriteSingle(VehicleHealth);
            writer.WriteBoolean(VehicleEngineDisabled);
            writer.WriteBoolean(VehicleJointAttached);
        }
    ...
    internal static WorldBodySnapshot Read(ref PacketReader reader)
    {
        ...
        var simulated = reader.ReadBoolean();
        var awake = reader.ReadBoolean();
        var railing = reader.ReadBoolean();
        var railingAttached = reader.ReadBoolean();
        var vehiclePart = reader.ReadBoolean();
        ...
        if (vehiclePart)
        {
            ...
            engineDisabled = reader.ReadBoolean();
            jointAttached = reader.ReadBoolean();
        }
