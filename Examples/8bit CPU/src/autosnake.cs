public static class AutoSnake
{
    public static void Main()
    {
        while (true)
        {
            ...
            while (true)
            {
                direction = Pathfinder.Find(head, food); // yea, the softweare snake pathfinder takes a step once every ~39s, so a hardware version has been added. Doesn't your CPU have a hardware BFS snek pathfinder?
